...
// Route default untuk halaman proyek
...
// Route untuk pencarian proyek
Route::get('/projects', [ProjectController::class, 'index'])->name('projects.search');

// Route untuk tugas terkait proyek
